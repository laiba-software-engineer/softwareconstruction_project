...
import javax.swing.table.DefaultTableModel;
	...
	public class EyeMakeup extends javax.swing.JFrame {
	     ...
	     */
	    public EyeMakeup() throws FileNotFoundException, IOException {
	        initComponents();
	        ImageIcon img = new ImageIcon("src/media/images(10).jpg");
	    ...
	    private void initComponents() {
	        ...
	        lblWelcomeAdminPanel.setText("                                                 Eye Makeup Section");
	        ...
	        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/media/download.jpg"))); // NOI18N
	                ...
	                for(i=0; i<tableLines.length;i++){
	                    ...
	                    try{
	                        ...
	                        if(prodname.equals(tableRow[1]) && stockQuantity > 0){
	                            ...
	                            pw.println(rowData[0]+","+ rowData[1] + ","+ prodname + "," +"Eye Makeup,"+ quantity +","+ rate*quantity+","+ dtf.format(now) );
	                            ...
	                            break;
	                                ...
	                                JOptionPane.showMessageDialog(this, "We have only " + stockQuantity + " "+prodname+ " in our stock");
	                            }
	                ...
	                try (BufferedWriter bwp = new BufferedWriter(new FileWriter(file)); PrintWriter pwp = new PrintWriter(bwp)) {
	                   // System.out.println("Out of first loop");
	                    for(i=0; i<tableLines.length;i++){
	                        ...
	                        if(prodname.equals(tableRows[1]) && stockQuantity >= quantity ){
